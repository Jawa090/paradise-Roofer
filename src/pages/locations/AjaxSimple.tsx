...
export default function AjaxSimple() {
    return (
        <Layout>
                ...
                <div className="container max-w-6xl">
                    <div className="flex flex-col gap-8">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-bold uppercase tracking-wider">Ajax Services</span>
                            <div className="h-4 w-4 bg-[#FF9C45]"></div>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-bold uppercase tracking-tight leading-none">
                            Professional Services in<br />Ajax, Ontario
                        </h1>
            ...
            <section className="pb-20 bg-background">
                <div className="container max-w-6xl">
                    <div className="w-full h-[400px] md:h-[600px] overflow-hidden rounded-sm">
                        <img src={AjaxImage} alt="Ajax Services" className="w-full h-full object-cover" />
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-white p-8 rounded-xl border border-border shadow-sm hover:shadow-md transition-all group">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="text-2xl md:text-3xl font-bold uppercase mb-2">Roofing Services in Ajax, Ontario</h3>
                                    <p className="text-muted-foreground">
                                        Complete roofing solutions for residential and commercial properties in Ajax. From inspections to installations, repairs to replacements.
                                    </p>
                                </div>
                            </div>
                            ...
                            <Link to="/locations/Ajax/roofing">
                        ...
                        <div className="bg-white p-8 rounded-xl border border-border shadow-sm hover:shadow-md transition-all group">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="text-2xl md:text-3xl font-bold uppercase mb-2">Renovation Services in Ajax, Ontario</h3>
                                    <p className="text-muted-foreground">
                                        Professional renovation services to modernize and enhance your Ajax property. Quality workmanship for every project.
                                    </p>
                                </div>
                            </div>
                            <ul className="space-y-3 mb-6 ml-2">
                            ...
                            <Link to="/locations/Ajax/renovation">
                                <button className="bg-[#FF9C45] text-black px-6 py-3 font-bold uppercase tracking-wide hover:bg-[#ff8a22] transition-colors flex items-center gap-2">
