                ...
                <div className="container max-w-6xl">
                    <div className="flex flex-col gap-8">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold uppercase tracking-tight leading-none">
                            Roofing Services in<br />Richmond Hill, Ontario
                        </h1>
            ...
            <section className="py-20 bg-background">
                <div className="container max-w-6xl">
                    <div className="space-y-16">
                        {[
                            { icon: Eye, title: "Roof inspections & maintenance Services in Richmond Hill", desc: "We offer free drone roof inspections to safely assess your roof's condition, identify damage, and spot potential issues early—no ladders, no disruption. Our Richmond Hill maintenance services help extend the life of your roof and prevent costly repairs." },
                            { icon: Home, title: "Roof installation & replacement In Richmond Hill", desc: "Professional roof installation and roof replacement services in Richmond Hill, Ontario, using high-quality materials for durable, weather-resistant results." },
                            { icon: Wrench, title: "Roof repairs & leak detection in Richmond Hill", desc: "Professional roof repair and leak detection services in Richmond Hill, Ontario, preventing water damage and costly structural issues." },
                            { icon: Shield, title: "Asphalt shingle roofing services in Richmond Hill", desc: "Expert asphalt shingle roofing services in Richmond Hill, Ontario, providing reliable protection, affordability, and long-term performance." },
                            { icon: AlertTriangle, title: "Emergency Roof Repairs in Richmond Hill", desc: "24/7 emergency roof repair services in Richmond Hill, offering fast, reliable response to storm damage, leaks, and urgent roofing problems to protect your home." },
                            { icon: Hammer, title: "Eaves trough, Soffit & Fascia Services in Richmond Hill", desc: "Professional eaves trough, soffit, and fascia services in Richmond Hill, Ontario, protecting your home from water damage while enhancing its exterior appearance and durability." }
                        ].map((item, i) => (
