...
export default function MississaugaRoofing() {
    return (
        <Layout>
            {/* Hero Text Section */}
                ...
                <div className="container max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                        {[
                            ...
                            "Eaves trough, soffit & fascia services"
                        ].map((service, i) => (
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="bg-white p-8 rounded-xl border border-border shadow-sm">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="text-2xl md:text-3xl font-bold uppercase mb-2">Roof installation & replacement In Mississauga</h3>
                                    <p className="text-muted-foreground">
                                        Professional roof installation and roof replacement services in Mississauga, Ontario, using high-quality materials for durable, weather-resistant results.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-xl border border-border shadow-sm">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="text-2xl md:text-3xl font-bold uppercase mb-2">Roof repairs & leak detection in Mississauga</h3>
                                    <p className="text-muted-foreground">
                                        Professional roof repair and leak detection services in Mississauga, Ontario, preventing water damage and costly structural issues.
                                    </p>
                                </div>
                            </div>
                        </div>
